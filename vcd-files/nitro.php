...
<head>
  ...
  <body style="margin:0px;padding:0px;overflow:hidden">
    <iframe src="<?php echo PATH; ?>/nitro/index.html?sso=<?php echo $Functions->Me('auth_ticket'); ?>" frameborder="0" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;position:absolute;top:0px;left:0px;right:0px;bottom:0px" height="100%" width="100%"></iframe>
